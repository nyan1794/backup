...
public class MyPageDAO {
	 ...
	 * @throws SQLException
	 */
	public int buyItemHistoryDelete(String user_master_id,String id) throws SQLException {
		Connection connection = dbConnector.getConnection();
	...
	public ArrayList<MyPageDTO> getMyPageResult(String user_master_id) throws SQLException {
		ArrayList<MyPageDTO> myPageDTO = new ArrayList<MyPageDTO>();
		Connection connection = dbConnector.getConnection();
