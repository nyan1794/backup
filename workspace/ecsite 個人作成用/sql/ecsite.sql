...
drop table if exists shop_order_transaction;

create table shop_order_transaction(
shop_name varchar(100),
item_id int,
item_name varchar(50),
item_count int,
item_total_price int,
shop_order_total_price int,
order_num varchar(16),
buy_zipcode varchar(16),
buy_prefecture varchar(10),
buy_city varchar(100),
buy_address varchar(100),
buy_building varchar(100),
buy_user_name varchar(100),
buy_user_id varchar(100),
buy_date datetime
);

INSERT INTO shop_login_transaction(shop_id, shop_pass, shop_name,shop_email,shop_code) VALUES("1","1","Internous","nyandy1794@gmail.com",1289);
INSERT INTO shop_login_transaction(shop_id, shop_pass, shop_name,shop_email,shop_code) VALUES("2","2","安田材木","nyanapple1794@gmail.com",1289);
